...
<body>
    ...
    <div class="form-container">
        <form action="/restaurants/${restaurant.restaurantId}/menu/add" method="post">
            ...
            <input type="text" name="itemType" id="itemType"/><br>
            
            <label for="availableFrom">Available From:</label>
            <input type="time" name="availableFrom" id="availableFrom" required/><br>
            
            <label for="availableUntil">Available Until:</label>
            <input type="time" name="availableUntil" id="availableUntil" required/><br>
