    ...
    <div class="form-container">
        <form action="/restaurants/${restaurant.restaurantId}/menu/edit/${menuItem.itemId}" method="post">
            <div class="form-group">
                ...
                <input type="text" name="itemName" id="itemName" value="${menuItem.itemName}" required/>
            </div>
            <div class="form-group">
                <label for="itemDescription">Description:</label>
                <textarea name="itemDescription" id="itemDescription">${menuItem.itemDescription}</textarea>
            </div>
            <div class="form-group">
                <label for="price">Price:</label>
                <input type="number" name="price" id="price" value="${menuItem.price}" required/>
            </div>
            <div class="form-group">
                <label for="itemType">Item Type:</label>
                <input type="text" name="itemType" id="itemType" value="${menuItem.itemType}"/>
            </div>
            <div class="form-group">
                <label for="availableFrom">Available From:</label>
                <input type="time" name="availableFrom" id="availableFrom" value="${menuItem.availableFrom}" required/>
            </div>
            <div class="form-group">
                <label for="availableUntil">Available Until:</label>
                <input type="time" name="availableUntil" id="availableUntil" value="${menuItem.availableUntil}" required/>
            </div>
